...
| 화면 | 이름 | 노드 | rev |
|---|---|---|---|
| `main` | 조리 화면 | 69 | `8e29b8de` |
| `main_copy` | 김밥썰기 | 25 | `31cc06bf` |
| `main_copy2` | 김밥말기1 | 40 | `b9a1ebfc` |
| `main_copy2_copy` | 김밥말기2 | 25 | `e8ce1d72` |
| `main_copy2_copy2` | 김밥서빙 | 30 | `8750a12b` |
| `main_copy3` | 조리 화면1 | 76 | `2d78a953` |
| `blank` | 로비화면 | 1 | `78bc3f96` |
...
생성 시각: 2026-08-10T11:18:03.988Z · 하네스 v1
