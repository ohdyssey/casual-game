# main_copy2_copy2 — 김밥서빙

1080×2400 · 노드 30개 · rev `8750a12b`

## 구조

- **상중단** (9개) — 손님2, 손님1, 칼, 새 레이어, 새 레이어 복사, 새 레이어 복사, 새 레이어, 새 레이어 복사 …
- **중앙** (15개) — 배경, 김밥발, 밥통, 준비_발, 준비_김, 참기름, 깨소금, 새 레이어 …
...
| `b` | `layer_6` | 칼 | image |
| `c` | `layer_10` | 참기름 | image |
| `d` | `layer_8` | 준비_발 | image |
| `e` | `layer_10_copy` | 깨소금 | image |
| `f` | `layer_16` | 새 레이어 | image |
| `g` | `layer_19` | 새 레이어 | image |
| `h` | `layer_4` | 새 레이어 | image |
| `i` | `layer_5` | 새 레이어 | image |
| `j` | `layer_5_copy` | 새 레이어 복사 | image |
| `k` | `layer_20` | 새 레이어 | image |
...
| `layer_4` | 새 레이어 | image | (318,1243) 445×104 | 에셋 up_Item_11_v3 |
| `layer_5` | 새 레이어 | image | (361,1157) 230×155 | 에셋 up_UI_04-3 |
| `layer_5_copy` | 새 레이어 복사 | image | (616,1171) 209×159 | 에셋 up_UI_04-2_v2 |
