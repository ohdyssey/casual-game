 ...
 *
 *   세로 HD 1080×2400. 문서 2개: main(플레이 화면) + home(타워 레벨맵).
 */
...
export default {
  ...
  config: {
    ...
    docs: [
      { id: 'main', name: '플레이 화면', file: 'ui/layouts/main.json', sample: {},
        getDefault: () => ({ frame: { designW: 1080, designH: 2400 }, nodes: [] }) },
      { id: 'home', name: '타워 홈/레벨맵', file: 'ui/layouts/home.json', sample: {},
        getDefault: () => ({ frame: { designW: 1080, designH: 2400 }, nodes: [] }) },
    ],
