...
1080×2400 · 노드 47개 · rev `15ac3cd7`

## 구조

- **상단** (9개) — 코인 패널, 125,250, 125,250 복사, 125,250 복사, 상점, t, 리그, t 복사 …
- **상중단** (12개) — 하늘, 3층 Bean&Bloom, 지붕, 패키지, t 복사, 코인 상점, t 복사, 랭킹 …
- **중앙** (7개) — 원경, 중경, 중경 복사, 2층 GoldenCrust, 새 레이어 복사, 세무원, Glass 복사
- **중하단** (12개) — 자동차3, 가로등, 가로등 복사, 소화전, 소화전 복사, 1층 로비, 소방관, Glass 복사 …
...
| `4` | `layer_11_copy5` | 시즌패스 | button? |
| `5` | `layer_11_copy` | 패키지 | button? |
| `6` | `layer_11_copy2` | 코인 상점 | button? |
| `7` | `layer_11_copy4` | 랭킹 | button? |
| `8` | `layer_11` | 상점 | button? |
| `9` | `layer_11_copy3` | 리그 | button? |
| `a` | `layer_17` | 스와이프 좌 | button? |
| `b` | `layer_17_copy` | 스와이프 우 | button? |
| `c` | `layer_7` | ㅒ | text |
| `d` | `layer_5` | 125,250 | text |
| `e` | `layer_13_copy6` | t 복사 | text |
| `f` | `layer_13` | t | text |
| `g` | `layer_13_copy` | t 복사 | text |
| `h` | `layer_13_copy2` | t 복사 | text |
| `i` | `layer_13_copy4` | t 복사 | text |
| `j` | `layer_13_copy5` | t 복사 | text |
| `k` | `layer_5_copy2` | 125,250 복사 | text |
...
| `layer_2` | 1층 로비 | image | (121,1702) 858×527 | 에셋 up_Slitare_Office_01_v2 |
| `layer_3` | 소방관 | image | (509,1929) 110×215 | 에셋 up_Solirare_Officer_01 |
| `layer_2_copy` | 2층 GoldenCrust | image | (121,1192) 859×528 | 에셋 up_Slitare_Office_02_v2 |
| `layer_3_copy` | 새 레이어 복사 | image | (500,1369) 104×246 | 에셋 up_Solirare_Officer_02 |
| `layer_6_copy` | Glass 복사 | image | (147,1554) 816×131 | 에셋 up_Slitare_BG_Glass |
| `layer_2_copy2` | 3층 Bean&Bloom | image | (121,693) 832×511 | 에셋 up_Slitare_Office_03_v2 |
| `layer_6` | 지붕 | image | (120,229) 840×477 | 에셋 up_Slitare_Office_roof |
...
| `layer_3_copy2` | 세무원 | image | (488,863) 104×262 | 에셋 up_Solirare_Officer_03 |
...
| `layer_6_copy2` | Glass 복사 | image | (147,1053) 816×131 | 에셋 up_Slitare_BG_Glass |
| `layer_7` | ㅒ | text | (407,576) 260×48 | "OHDYSSEY CITY" · 크기 근사 |
