# home_copy2_copy2 — 경쟁부지

1080×2400 · 노드 44개 · rev `2362fcc6`

## 구조

- **상단** (9개) — 코인 패널, 125,250, 125,250 복사, 125,250 복사, 상점, t, 리그, t 복사 …
- **상중단** (11개) — 하늘, 패키지, t 복사, 코인 상점, t 복사, 랭킹, t 복사, 시즌패스 …
- **중앙** (6개) — 원경, 중경, 중경 복사, 2층 GoldenCrust, 3층 Bean&Bloom, Glass 복사
- **중하단** (11개) — 자동차3, 가로등, 가로등 복사, 소화전, 소화전 복사, 1층 로비, Glass 복사, 부지구입 …
...
| `c` | `layer_5` | 125,250 | text |
| `d` | `layer_13_copy6` | t 복사 | text |
| `e` | `layer_13` | t | text |
| `f` | `layer_13_copy` | t 복사 | text |
| `g` | `layer_13_copy2` | t 복사 | text |
| `h` | `layer_13_copy4` | t 복사 | text |
| `i` | `layer_13_copy5` | t 복사 | text |
| `j` | `layer_5_copy2` | 125,250 복사 | text |
| `k` | `layer_5_copy` | 125,250 복사 | text |
...
| `layer_2` | 1층 로비 | image | (121,1705) 858×521 | 에셋 up_Bank_01 |
| `layer_2_copy` | 2층 GoldenCrust | image | (121,1196) 859×527 | 에셋 up_Bank_02 |
| `layer_6_copy` | Glass 복사 | image | (228,1585) 638×102 | 에셋 up_Slitare_BG_Glass |
| `layer_2_copy2` | 3층 Bean&Bloom | image | (124,712) 832×505 | 에셋 up_Bank_03 |
...
| `layer_2_copy3` | 3층 Bean&Bloom 복사 | image | (124,213) 832×505 | 에셋 up_Bank_04 |
| `layer_6_copy2` | Glass 복사 | image | (221,1081) 638×102 | 에셋 up_Slitare_BG_Glass |
| `layer_6_copy3` | Glass 복사 | image | (221,604) 638×102 | 에셋 up_Slitare_BG_Glass |
